...
/**
 * Owns [ScoreController] for the phone UI. Composables collect [state] and call
...
class ScoreViewModel(application: Application) : AndroidViewModel(application) {
    ...
    /**
     * Walks ± placement through right → left → center.
     */
    fun cycleLayout() {
        viewModelScope.launch { controller.cycleLayout() }
    }
}
